...
(function() {
  ...
  // Set handler for scene switch (now using <button> elements)
  sceneElements.forEach(function(el) {
    el.addEventListener('click', function() {
      var scene = scenes.find(function(s) { return s.data.id === el.getAttribute('data-id'); });
      if (scene) {
        switchScene(scene);
  ...
  // Add debug logs for control initialization
  console.log('All UI controls initialized as <button> elements for accessibility.');
